...
PO3_CfgRespawn_PreDefinedPositions = [
	...
	,[west,"redeploy_west_marine","b_naval","Marina South"]
	,[west,"redeploy_west_marine_1","b_naval","Marina North"]
	,[west,"redeploy_west_marine_2","b_naval","Aircraft section"]
	,[west,"redeploy_west_marine_3","b_naval","FOB Arcadia"]
