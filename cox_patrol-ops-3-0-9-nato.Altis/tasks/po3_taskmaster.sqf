...
// ,"PO3_task_m04_captureIntel"		// <!-- TEST cant pick up intel
...
//	,"PO3_task_m14_defendDamagedBoat"	// <!-- TEST boat doesnt spawn near marker
	,"PO3_task_m15_defendTown"			// <!-- TEST
	,"PO3_task_m16_destroyArtillery"	// <!-- TEST
	// ,"PO3_task_m17_destroyCaches"		// <!-- TEST boring
