...
// Added 50% chance of an addition weak wave.
// =========================================================================================================
...
_spawnAmbush = {
	private["_position","_b","_ingress","_grp","_minVehicles","_maxVehicles","_midVehicles","_vehicleCount"];
	...
	// maximum of 10 vehicles, minimum of 0
	...
	if(random 1 > 0.3 && _equation >= 7) then { [_position,(PO3_side_3 select 0),([1] call PO3_fnc_getVehicleTypes) call PO3_fnc_getArrayRandom,format["EN_GroupForce_%1",round random 9]] call PO3_fnc_supportCreateHeloReinforcements; };
};
...
if( random 1 > 0.5) then {[_position,_b/2] call _spawnAmbush; sleep 45;};
