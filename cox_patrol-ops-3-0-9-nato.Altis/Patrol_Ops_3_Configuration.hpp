...
/* 7 - Transport Helos */	,["O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_bench_black_F","O_Heli_Transport_04_covered_F"]
/* 8 - Transport Planes */	,[]
...
PO3_CfgRespawn_PreDefinedPositions = [
	...
	,[west,"redeploy_west_marine","b_naval","Aircraft section"]
	,[west,"redeploy_west_marine_1","b_naval","Helicopter section"]
	,[west,"redeploy_west_marine_2","b_naval","Marina Base South"]
	,[west,"redeploy_west_marine_3","b_naval","Peninsula Base"]
	,[west,"redeploy_west_marine_4","b_hq","FOB Fotia"]
	,[west,"redeploy_west_marine_5","b_hq","Debrief Beach"]
...
PO3_CfgLogistics_UnitLoadouts = [
	["Rifleman"
		...
		,[/*Items*/
				"Binocular","Laserdesignator","Rangefinder","FirstAidKit","ItemCompass","ItemGPS","ItemMap","Item_tf_anprc152","ItemWatch","Medikit","ToolKit"
				,"H_Shemag_khk","H_Shemag_olive","H_Shemag_olive_hs","H_Shemag_tan"
				,"V_BandollierB_blk","V_BandollierB_khk","V_BandollierB_oli","optic_arco"
			/*NATO*/
