...
_tipogrupo = "BUS_InfTeam_AT";
_tipoVeh = "B_APC_Wheeled_01_cannon_F";
...
_grupo = [_orig, side_blue, (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Infantry" >> _tipogrupo)] call BIS_Fnc_spawnGroup;
