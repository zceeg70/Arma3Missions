...
switch _tipo do {
	case sol_A_AA: {_skilleSet = 0;}; // assistant AA
	case sol_A_AR: {_skilleSet = 3;}; // assistant autorifle
	case sol_A_AT: {_skilleSet = 0;}; // assistant AT
	case sol_AA: {_skilleSet = 0;}; // AA
	case sol_AR: {_skilleSet = 3;}; // autorifle
	case sol_AT: {_skilleSet = 0;}; // AT
	...
	case sol_MG: {_skilleSet = 3;}; // MG
	case sol_MK: {_skilleSet = 2;}; // marksman
	case sol_SL: {_skilleSet = 1;}; // squad leader
	case sol_TL: {_skilleSet = 1;}; // team leader
	case sol_TL2: {_skilleSet = 1;}; // team leader
	case sol_EXP: {_skilleSet = 0;}; // explosives
	/*case sol_R_L: {}; // rifleman, light*/
	case sol_REP: {_skilleSet = 0;}; // repair
	/*case sol_UN: {}; // unarmed*/
	/*case sol_RFL: {}; // rifleman*/
	case sol_SN: {_skilleSet = 2;}; // sniper
	case sol_SP: {_skilleSet = 2;}; // spotter
	case sol_MED: {_skilleSet = 0;}; // medic
	case sol_ENG: {_skilleSet = 0;}; // engineer
	case sol_OFF: {_skilleSet = 1;}; // officer
	case sol_OFF2: {_skilleSet = 1;}; // officer
	...
	case sol_HPIL: {_skilleSet = 1;};  // helicopter pilot (unarmed)
	case sol_HPIL2: {_skilleSet = 1;}; // helicopter pilot (armed)
	case sol_PIL: {_skilleSet = 1;}; // pilot
	/*case sol_UAV: {}; // UAV controller*/

	/*case sol_SUP_AMG: {}; // assistant HMG*/
	/*case sol_SUP_AMTR: {}; // assistant mortar*/
	case sol_SUP_GMG: {_skilleSet = 3;}; // GMG gunner
	case sol_SUP_MG: {_skilleSet = 3;}; // HMG gunner
