...
_traidor = _grptraidor createUnit [opIOfficer_2, _postraidor, [], 0, "NONE"];
_traidor allowDamage false;
_sol1 = _grptraidor createUnit [opIUSL, _posSol1, [], 0, "NONE"];
_sol2 = _grptraidor createUnit [opIURifle, _posSol2, [], 0, "NONE"];
