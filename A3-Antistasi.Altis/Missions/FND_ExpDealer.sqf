...
[[_devin,"conversation"],"flagaction"] call BIS_fnc_MP;
...
if ({(side _x isEqualTo side_blue) && (_x distance _devin < 10)} count allPlayers > 0) then {
	...
	line2 = ["Devin", "Everything is first-hand from the top experts in the field."];
