...
//Don't touch them.
antistasiVersion = "v 1.5.A -- modded ";
...
//minefieldMrk = [];
staticsToSave = [];
minimoFPS = 20;//initial FPS minimum.
//destroyedCities = [];
autoHeal = false;
...
opISquad = 			""; // squad of infantry
opISpecOps = 		""; // spec opcs
opISniper = 		""; // sniper team

opIOfficer = 		""; // officer/official
opIPilot = 			""; // pilot
opIOfficer_2 = 		""; // officer/traitor
opIUSL = 			""; // squad leader, urban camo
opIURifle = 		""; // rifleman, urban camo
...
BMreqItems = []; publicVariable "BMreqItems"; // list of items to be gathered for BM missions
BMcurItems = []; publicVariable "BMcurItems"; // list of BM items already gathered
